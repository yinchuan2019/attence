...
CREATE TABLE `att_student` (
  ...
  `stu_line` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'line',
...
CREATE TABLE `att_teacher` (
  ...
  `tea_phone_num` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '電話番号/电话号',
  `tea_wechat` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Wechat/微信号',
  `tea_line` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'line',
